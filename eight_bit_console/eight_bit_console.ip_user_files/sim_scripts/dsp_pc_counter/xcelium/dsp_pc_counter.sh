...
#
# Script generated by Vivado on Sat Mar 30 11:17:41 MDT 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dsp_pc_counter.sh
...
#
# Usage        : dsp_pc_counter.sh
#                dsp_pc_counter.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dsp_pc_counter.sh [-reset_run]
#                dsp_pc_counter.sh [-reset_log]
#                dsp_pc_counter.sh [-help]
#
...
#                script (type 'dsp_pc_counter.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_11 -libname c_reg_fd_v12_0_7 -libname xbip_dsp48_wrapper_v3_0_5 -libname xbip_pipe_v3_0_7 -libname xbip_dsp48_addsub_v3_0_7 -libname xbip_addsub_v3_0_7 -libname c_addsub_v12_0_16 -libname c_gate_bit_v12_0_7 -libname xbip_counter_v3_0_7 -libname c_counter_binary_v12_0_17 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_11 c_reg_fd_v12_0_7 xbip_dsp48_wrapper_v3_0_5 xbip_pipe_v3_0_7 xbip_dsp48_addsub_v3_0_7 xbip_addsub_v3_0_7 c_addsub_v12_0_16 c_gate_bit_v12_0_7 xbip_counter_v3_0_7 c_counter_binary_v12_0_17 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "dsp_pc_counter.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dsp_pc_counter.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dsp_pc_counter
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dsp_pc_counter -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/carson/Nextcloud/Documents/school/ECEN340/final_project/8-bit-console-clone-verilog/eight_bit_console/eight_bit_console.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dsp_pc_counter_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dsp_pc_counter.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dsp_pc_counter.sh [-help]\n\
Usage: dsp_pc_counter.sh [-step]\n\
Usage: dsp_pc_counter.sh [-lib_map_path]\n\
Usage: dsp_pc_counter.sh [-reset_run]\n\
Usage: dsp_pc_counter.sh [-reset_log]\n\
Usage: dsp_pc_counter.sh [-keep_index]\n\
Usage: dsp_pc_counter.sh [-noclean_files]\n\n\
