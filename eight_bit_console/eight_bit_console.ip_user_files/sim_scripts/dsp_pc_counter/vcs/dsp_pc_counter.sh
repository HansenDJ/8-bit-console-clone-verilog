...
design_libs=(xbip_utils_v3_0_11 c_reg_fd_v12_0_7 xbip_dsp48_wrapper_v3_0_5 xbip_pipe_v3_0_7 xbip_dsp48_addsub_v3_0_7 xbip_addsub_v3_0_7 c_addsub_v12_0_16 c_gate_bit_v12_0_7 xbip_counter_v3_0_7 c_counter_binary_v12_0_17 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work c_gate_bit_v12_0_7 $vhdlan_opts \
  "../../../ipstatic/hdl/c_gate_bit_v12_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vhdlan.log 2>/dev/null

  vhdlan -work xbip_counter_v3_0_7 $vhdlan_opts \
  "../../../ipstatic/hdl/xbip_counter_v3_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vhdlan.log 2>/dev/null

  vhdlan -work c_counter_binary_v12_0_17 $vhdlan_opts \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dsp_pc_counter -o dsp_pc_counter_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dsp_pc_counter_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/carson/Nextcloud/Documents/school/ECEN340/final_project/8-bit-console-clone-verilog/eight_bit_console/eight_bit_console.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key dsp_pc_counter_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dsp_pc_counter_simv.daidir vcs_lib c.obj)
