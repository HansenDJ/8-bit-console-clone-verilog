...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xbip_utils_v3_0_11 -L c_reg_fd_v12_0_7 -L xbip_dsp48_wrapper_v3_0_5 -L xbip_pipe_v3_0_7 -L xbip_dsp48_addsub_v3_0_7 -L xbip_addsub_v3_0_7 -L c_addsub_v12_0_16 -L c_gate_bit_v12_0_7 -L xbip_counter_v3_0_7 -L c_counter_binary_v12_0_17 -L xil_defaultlib -L secureip -L xpm --snapshot dsp_pc_counter xil_defaultlib.dsp_pc_counter -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dsp_pc_counter -key {Behavioral:sim_1:Functional:dsp_pc_counter} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dsp_pc_counter.wdb xsim.dir libdpi.so)
